...
def deep_scan(root_dir="~/"):
    """
    Busca exhaustivamente repositorios que contengan .git Y meta.json adaptado al formato v2.
    """
    found_assets = {}
                ...
                with open(meta_path, 'r', encoding='utf-8') as f:
                    ...
                    if asset_id:
                        found_assets[asset_id] = {
                            ...
                            "status": data.get("status", {}),         # Absorbe el árbol completo (activity, maturity, scopes, etc.)
                            "environment": data.get("environment", {}),
                            "repository": data.get("repository", {}),   # Cambio de 'links' a 'repository'
